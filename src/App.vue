<template>
  <div id="app">
    ...
    <div class="wrapper" style="position : relative; left : 0px;">

      <div class="row-header" :style="[{'grid-template-columns' : grid.setting.headerWidth}]">
...
export default {
  ...
  created : function(){
    this.$store.commit('setGrid',this.main_grid)
  }
}
</script>
<style>
